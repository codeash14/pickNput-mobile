...
const chooseShape = (e) =>{
    ...
    if($activeShape === null){
        if(parent.childElementCount > 0 && parent.firstElementChild.classList.contains('grin') || parent.firstElementChild.classList.contains('laugh') || parent.firstElementChild.classList.contains('angel') || parent.firstElementChild.classList.contains('nerd') || parent.firstElementChild.classList.contains('crazy') || parent.firstElementChild.classList.contains('swag') || parent.firstElementChild.classList.contains('wink') || parent.firstElementChild.classList.contains('smile')){
...
const moveShapeToSelectedRectangle = (e) =>{
    ...
    if (target.classList.contains('rectangle') && target.childElementCount < 3 && $activeShape !== null){
